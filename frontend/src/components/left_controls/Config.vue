<template>
    ...
    <div class="config_div">
        <span style="font-weight: bold">Batchsize:</span>
        <input type="range" min="1" max="256" value="1" v-model.lazy="batch_size" style="width: 80px" />
        <input type="number" v-model.lazy="batch_size" min="1" max="256" style="
        width: 40px;
        background: #fff;
        color: #000;
        padding: 5px;
    ...
    <div class="config_div" v-if="inference_stage != 'chat'">
        <span style="font-weight: bold">Seq-Length:</span>
        <input type="range" v-model.lazy="seq_length" min="1" max="4096" value="1024" style="width: 80px" />
        <!-- <span id="seq_length">1024</span> -->
        <input type="number" v-model.lazy="seq_length" min="1" max="4096" style="
        width: 45px;
        outline: 1;
        background: #fff;
        color: #000;
    ...
    <div class="config_div" v-else>
        <span style="font-weight: bold">PromptLength:</span>
        <input type="range" min="1" max="4096" value="1024" v-model.lazy="seq_length" style="width: 80px" />
        <!-- <span id="seq_length">1024</span> -->
        <input type="number" v-model.lazy="seq_length" min="1" max="4096" style="
        width: 45px;
        outline: 1;
      ...
      " />
        <br />
        <span style="font-weight: bold">GenerateLength:</span>
        <input type="range" min="1" max="4096" value="1024" v-model.lazy="gen_length" style="width: 80px" />
        <!-- <span id="seq_length">1024</span> -->
        <input type="number" v-model.lazy="gen_length" min="1" max="4096" style="
        width: 45px;
        outline: 1;
        background: #fff;
        color: #000;
    ...
    <div class="config_div">
        <span style="font-weight: bold; padding-right: 10px ;">Weight Quantization : </span>
    ...
    <div class="config_div">
        <span style="font-weight: bold; padding-right: 10px ;">Activation Quantization : </span>
    ...
    <div class="config_div">
        <span style="font-weight: bold; padding-right: 10px ;">KV Cache Quantization : </span>
    ...
    <div class="config_div">
        <span style="font-weight: bold; padding-right: 10px ;">Use FlashAttention : </span>
    ...
    <div>
        ...
        <p>
            <strong>NOTE : </strong>The time estimated by the roofline model represents the theoretical
            performance that the hardware can achieve. The purpose of creating this
            tool is to help readers gain a clearer understanding of the key factors
            that influence LLM inference. Only the relative relationships can be
            referenced.
        </p>
    </div>
